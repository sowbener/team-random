...
{
    internal class YbSettingsWWM : Styx.Helpers.Settings
    {

        public YbSettingsWWM()
            : base(InternalSettings.SettingsPath + "_Windwalker.xml")
        {
        }
        ...
        public Enum.AbilityTrigger EnergizingBrew { get; set; }
        ...
        public Enum.AbilityTrigger TigereyeBrew { get; set; }
        ...
        public Enum.AbilityTrigger ChiBrew { get; set; }
        ...
        public Enum.AbilityTrigger Xuen { get; set; }
