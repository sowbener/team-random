...
{
    internal class YbSettingsENS : Styx.Helpers.Settings
    {

        public YbSettingsENS()
            : base(InternalSettings.SettingsPath + "_Enhancement.xml")
        {
        }
        ...
        [Setting]
        [Styx.Helpers.DefaultValue(Enum.WeaponImbueM.Windfury)]
        [Category("Enhancement - Ability Options")]
        ...
        [Setting]
        [Styx.Helpers.DefaultValue(Enum.WeaponImbueO.Flametongue)]
        [Category("Enhancement - Ability Options")]
        [DisplayName("Buff Off-Hand")]
        [Description("Select which buff you want on your Off-hand.")]
        public Enum.WeaponImbueO WeaponImbueSelectorO { get; set; }
        ...
        public Enum.AbilityTrigger FeralSpirit { get; set; }
