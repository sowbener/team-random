       ...
       internal static Composite ComSt()
        {
            return new PrioritySelector(
                ...
                Spell.Cast("Revealing Strike", ret => Lua.PlayerComboPts < 5 && Spell.GetAuraTimeLeft("Revealing Strike", Me.CurrentTarget) < 3),
                Spell.Cast("Sinister Strike", ret => Lua.PlayerComboPts < 5 && Spell.GetAuraTimeLeft("Revealing Strike", Me.CurrentTarget) > 3),
