...
namespace YourBuddy.Core.Helpers
{
    ...
    internal static class DoTTracker
    {
        ...
        private static void UpdateStatInfo(ulong destGuid, int spellId)
        {
            ...
            try
            {
                ...
                if (!StatInfos.ContainsKey(hash))
                {
                    ...
                    Logger.DiagLogFb("Added {0} with stats AP {1}, Int {2}, Crit {3}, MeleeHaste {4}, SpellHaste {5}, Mastery {6}, SpellPower {7}",
                        spellId,
                ...
                {
                    Logger.DiagLogFb("Updated {0} with stats AP {1}, Int {2}, Crit {3}, MeleeHaste {4}, SpellHaste {5}, Mastery {6}, SpellPower {7}",
                        spellId,
                        Lua._secondaryStats.AttackPower,
                        Lua._secondaryStats.Intellect,
                        Lua._secondaryStats.Crit,
            ...
            {
                Logger.DiagLogFb("UpdateStatInfo : {0}", ex);
            }
        }
        ...
        private static void AttachCombatLogEvent()
        {
            ...
            Logger.CombatLogFb("[DotTracker] Attached to combat log");
        ...
        private static void RemoveDotDamage(ulong destGuid, int spellId)
        {
            ...
            {
                Logger.DiagLogFb("RemoveDotDamage : {0}", ex);
            }
        }
        ...
        public static bool NeedMeleeRefresh(WoWUnit u, int spellId)
        {
            if (u != null)
            {
                bool raisedAP = (SpellStats(u, spellId).AttackPower + 3000 < Lua._secondaryStats.AttackPower);
                ...
                {
                    Logger.DiagLogFb("[DotTracker] Spell {0} applied with {1} AP - {2} Crit - {3} Haste - {4} Mastery / stats now {5} AP - {6} Crit - {7} Haste - {8} Mastery",
                        spellId,
        ...
        public static bool NeedCasterRefresh(WoWUnit u, int spellId)
        {
            if (u != null)
            {
                ...
                {
                    Logger.DiagLogFb("[DotTracker] Spell {0} applied with {1} SP - {2} Crit - {3} Haste - {4} Mastery / stats now {5} SP - {6} Crit - {7} Haste - {8} Mastery",
                        spellId,
