...
namespace YourRaidingBuddy.Core.Helpers
{
    public class DamageTracker
    {
        ...
        public static void Initialize()
        {
            ...
            Logger.CombatLogFb("Yb: Damage Tracker Initialized.");
        }
        ...
        public static double CalculateEstimatedAbsorbValue()
        {
            using (new PerformanceLogger("CalculateEstimatedAbsorbValue"))
            {
                ...
                {
                    Logger.DiagLogFb("Yb: Failed CalculateEstimatedAbsorbValue - {0}", exabsorbcalc);
                }
            }
            return 0;
        }
        ...
        public static double CalculateEstimatedBlockValue()
        {
            using (new PerformanceLogger("CalculateEstimatedBlockValue"))
            {
                ...
                {
                    Logger.DiagLogFb("Yb: Failed CalculateEstimatedBlockValue - {0}", exblockcalc);
                }
            }
            return 1;
        }
        ...
        #region Brewmaster-Spec Functions
        ...
        //        {
        //            Logger.DiagLogFb("Yb: Failed CalculateEstimatedBlockValue - {0}", exstancetrack);
        //        }
        //    }
        //    return false;
        //}
