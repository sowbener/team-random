...
namespace YBMoP_BT_Warrior.Interfaces.GUI
{
    public partial class YBGeneralGui : Form
    {
        ...
        #region GUI Load & Reload Routines
        ...
        private static void ReloadRoutine()
        {
            RoutineManager.ReloadRoutineAssemblies();
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            YBLogger.InitLogO("Advanced settings for YourBuddy MoP BT saved!");
            Close();
        }
        #endregion
    }
