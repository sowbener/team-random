...
namespace BattlePetSwapper
{
    ...
    public class PluginSettings : Settings, IPluginProperties, IPluginSettings
    {
        ...
        public PluginSettings(IPluginLogger logger)
            : base((Application.StartupPath + "\\Plugins\\Pokehbuddy\\BattlePetSwapper\\" + NAMESPACE + "_" + (StyxWoW.Me != null ? StyxWoW.Me.Name : "") + ".xml"))
        {
            _logger = logger;
            _logger.Write("Loading Settings file:" + Application.StartupPath + "\\Plugins\\Pokehbuddy\\BattlePetSwapper\\"+NAMESPACE+"_*****.xml");
