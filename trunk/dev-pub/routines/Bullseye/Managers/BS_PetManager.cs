        ...
        public static Composite CreateHunterCallPetBehavior()
        {
            return new Decorator(
                ...
                new PrioritySelector(
                    ...
                    new Decorator(ret => MyPet == null && ((Me.Specialization == WoWSpec.HunterBeastMastery && SG.Instance.Beastmastery.CallPet != BsEnum.CallPet.None) || (Me.Specialization == WoWSpec.HunterSurvival && SG.Instance.Survival.CallPet != BsEnum.CallPet.None)),
                        new Sequence(
                            new Action(ret => Logger.DebugLog("CallPet: attempting Call Pet {0} - canbuff={1}", SG.Instance.General.CallPet, SpellManager.CanCast("Call Pet " + CallPetNumber.ToString(CultureInfo.InvariantCulture)))),
        ...
        public static int CallPetNumber
        {
            get
            {
                if (Me.Specialization == WoWSpec.HunterBeastMastery)
                {
                    ...
                    {
                        case BsEnum.CallPet.Pet1:
                            return 1;
                        case BsEnum.CallPet.Pet2:
                            return 2;
                        case BsEnum.CallPet.Pet3:
                            return 3;
                        case BsEnum.CallPet.Pet4:
                            return 4;
                        case BsEnum.CallPet.Pet5:
                            return 5;
                    }
                    return 0;
                }
