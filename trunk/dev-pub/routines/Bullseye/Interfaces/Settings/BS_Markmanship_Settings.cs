...
{
    internal class BsSettingsMM : Styx.Helpers.Settings
    {

        public BsSettingsMM()
            : base(BsSettings.SettingsPath + "_Marksmanship.xml")
        {
        }
        ...
        public BsEnum.AbilityTrigger SummonGargoyle { get; set; }
        ...
        public BsEnum.AbilityTrigger EmpowerRuneWeapon { get; set; }
        ...
        public BsEnum.AbilityTrigger UnholyFrenzy { get; set; }
        #endregion
