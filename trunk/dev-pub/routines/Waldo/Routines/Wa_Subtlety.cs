    ...
    class WaSubtlety
    {
        ...
        static Composite SubSt()
        {
            return new PrioritySelector(
                ...
                Spell.Cast("Ambush", ret => WaLua.PlayerComboPts < 5),
                ...
                new Decorator(ret => !Styx.WoWInternals.WoWSpell.FromId(8676).CanCast && !Me.HasAura("Vanish") && WaLua.PlayerComboPts < 5 || Lua.PlayerPower > 80 || WaTalentManager.HasTalent(18), ComboBuilders())
                        );
