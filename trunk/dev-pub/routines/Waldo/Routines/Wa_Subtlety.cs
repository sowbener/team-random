    ...
    class WaSubtlety
    {
        ...
        static Composite SubSt()
        {
            return new PrioritySelector(
                ...
                new Decorator(ret => !Styx.WoWInternals.WoWSpell.FromId(8676).CanCast && !Me.HasAura(51713) && (!Me.HasAura(11327) || !Me.HasAura(1784)) && WaLua.PlayerComboPts < 5, ComboBuilders())
                        );
        ...
        static Composite ComboBuilders()
        {
            ...
            Spell.Cast("Backstab", ret => StyxWoW.Me.CurrentTarget.MeIsBehind && (!Me.HasAura(11327) || !Me.HasAura(1784))),
            Pooling());
        }
