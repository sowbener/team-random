...
namespace Waldo.Routines
{
    class WaSubtlety
    {
        ...
        static Composite ComboBuilders()
        {
            ...
            Spell.Cast("Hemorrhage", ret => !StyxWoW.Me.CurrentTarget.MeIsBehind || (WaLua.PlayerComboPts == 4 && WaLua.PlayerPower > 79) || (!Me.HasAura(115191) && !Me.HasAura(31665) && !Me.HasAura(51713) && !Me.CurrentTarget.HasMyAura(89775))),
