                        ...
                        new Decorator(ret => !Spell.GlobalCooldown() && SH.Instance.ModeSelection == WaEnum.Mode.Hotkey,
                            new PrioritySelector(
                                ...
                                SubUtility(),
                                 ...
                                 Spell.Cast("Vanish", ret => WaLua.PlayerPower > 59 && G.ShadowDanceOffline && G.PremeditationOnline && WaLua.PlayerComboPts < 5 && !Me.CurrentTarget.HasMyAura(91021) && (!Me.HasAura(115191) || !Me.HasAura(115193)) && !Me.HasAura(51713) && Me.IsFacing(Me.CurrentTarget)),
        ...
        static Composite SubSt()
        {
            return new PrioritySelector(
               ...
               // Spell.Cast("Vanish", ret => Lua.PlayerPower <= 75 && WaLua.PlayerComboPts <= 3 && !Me.HasAura("Shadow Dance") && !Me.HasAura("Master of Subtlety") && !Me.CurrentTarget.HasMyAura("Find Weakness")),
                ...
                new Decorator(ret => !Styx.WoWInternals.WoWSpell.FromId(8676).CanCast && !Me.HasAura("Vanish") && WaLua.PlayerComboPts < 5, ComboBuilders())
                        );
