    ...
    class WaSubtlety
    {
        ...
        static Composite SubSt()
        {
            return new PrioritySelector(
                ...
                new Decorator(ret => Lua.PlayerComboPts == 5 || (AnticipationStacks < 5 && Lua.PlayerComboPts > 0) || (AnticipationStacks < 4 && Lua.PlayerComboPts > 1) || (AnticipationStacks < 3 && Lua.PlayerComboPts > 2) || (AnticipationStacks < 2 && Lua.PlayerComboPts > 3), Finishers()),
