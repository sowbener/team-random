...
{
    internal class WaSettingsA : Styx.Helpers.Settings
    {

        public WaSettingsA()
            : base(WaSettings.SettingsPath + "_Assassination.xml")
        {
        }
        ...
        public WaEnum.AbilityTrigger ShadowBlades { get; set; }
        ...
        public WaEnum.AbilityTrigger Tier6Abilities { get; set; }

        [Setting]
        [Styx.Helpers.DefaultValue(WaEnum.PreperationUsage.OnBossAndVanishCooldown)]
        [Category("Assassination - Ability Options")]
        [DisplayName("Preparation")]
        [Description("Select the usage of Preparation")]
        public WaEnum.PreperationUsage PreperationUsage { get; set; }
        ...
        public WaEnum.AbilityTrigger Vanish { get; set; }
        ...
        public WaEnum.AbilityTrigger ClassRacials { get; set; }
        ...
        public WaEnum.AbilityTrigger UseHands { get; set; }
        ...
        public WaEnum.AbilityTrigger Trinket1 { get; set; }
        ...
        public WaEnum.AbilityTrigger Trinket2 { get; set; }
        ...
        [Setting]
        [Styx.Helpers.DefaultValue(WaEnum.PoisonM.Deadly)]
        [Category("Assassination - Item Options")]
        [DisplayName("Poison Mainhand")]
        [Description("Select which poison to put on Main-Hand")]
        public WaEnum.PoisonM PoisonSelectorM { get; set; }

        [Setting]
        [Styx.Helpers.DefaultValue(WaEnum.PoisonO.Leeching)]
        [Category("Assassination  - Item Options")]
        [DisplayName("Poison Offhand")]
        [Description("Select which poison to put on Off-Hand")]
        public WaEnum.PoisonO PoisonSelectorO { get; set; }
