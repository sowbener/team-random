...
{
    internal class WaSettingsC : Styx.Helpers.Settings
    {

        public WaSettingsC()
            : base(WaSettings.SettingsPath + "_Combat.xml")
        {
        }
        ...
        public WaEnum.AbilityTrigger KillingSpree { get; set; }
        ...
        public WaEnum.AbilityTrigger AdrenalineRush { get; set; }
