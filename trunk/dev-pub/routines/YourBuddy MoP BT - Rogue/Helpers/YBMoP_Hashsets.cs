...
{
    public static class YBHashSets
    {
        public static LocalPlayer Me { get { return StyxWoW.Me; } }

        #region YBMoP - other Lists
        //public static bool TargetShieldBlockList(this WoWUnit unit)
        //{
        //    return unit != null && (ShieldBlockId.Contains(unit.Entry));
        //}
        //public static HashSet<uint> ShieldBlockId { get { return ShieldBlock; } }
        //private static readonly HashSet<uint> ShieldBlock = new HashSet<uint>
        //{
        ...
        public static bool DoNotUseOnTgt(this WoWUnit unit)
        {
        ...
        #region YBMoP BT - Dummy & Boss ID's
        ...
        private static readonly HashSet<uint> Bosses = new HashSet<uint> {
            ...
            34453, //Narrhok Steelbreaker <Rogue>
