...
{
    public partial class YBAssGui : Form
    {
        public YBAssGui()
        {
            InitializeComponent();
        ...
        {
            YBSettingsAss.Instance.Load();
            YBSettingsG.Instance.Load();

            #region ENUMs
            // ENUM - Berserker Rage
            comboVendetta.Items.Add(new CboItem((int)AbilityTrigger.Never, "Never"));
            comboVendetta.Items.Add(new CboItem((int)AbilityTrigger.OnBlTw, "On BL & TW"));
            comboVendetta.Items.Add(new CboItem((int)AbilityTrigger.OnBossDummy, "On Boss & Dummy"));
            comboVendetta.Items.Add(new CboItem((int)AbilityTrigger.Always, "Always"));
            ...
            // ENUM - ShadowBlades
            comboShadowBlades.Items.Add(new CboItem((int)AbilityTrigger.Never, "Never"));
            comboShadowBlades.Items.Add(new CboItem((int)AbilityTrigger.OnBlTw, "On BL & TW"));
            comboShadowBlades.Items.Add(new CboItem((int)AbilityTrigger.OnBossDummy, "On Boss & Dummy"));
            comboShadowBlades.Items.Add(new CboItem((int)AbilityTrigger.Always, "Always"));
            ...
            SetComboBoxEnum(comboVendetta, (int)YBSettingsAss.Instance.Vendetta);
            SetComboBoxEnum(comboClassRacials, (int)YBSettingsAss.Instance.ClassRacials);
            SetComboBoxEnum(comboShadowBlades, (int)YBSettingsAss.Instance.ShadowBlades);
            SetComboBoxEnum(comboVanish, (int)YBSettingsAss.Instance.Vanish);
            SetComboBoxEnum(comboPreperation, (int)YBSettingsAss.Instance.Tier4Abilities);
            SetComboBoxEnum(comboTier6, (int)YBSettingsAss.Instance.Tier6Abilities);
            SetComboBoxEnum(comboPoisonsM, (int)YBSettingsAss.Instance.PoisonSelectorM);
            SetComboBoxEnum(comboPoisonsO, (int)YBSettingsAss.Instance.PoisonSelectorO);
            SetComboBoxEnum(comboUseHands, (int)YBSettingsAss.Instance.UseHands);
            SetComboBoxEnum(comboTrinket1, (int)YBSettingsAss.Instance.Trinket1);
            SetComboBoxEnum(comboTrinket2, (int)YBSettingsAss.Instance.Trinket2);

            checkAutoAttack.Checked = YBSettingsAss.Instance.CheckAutoAttack;
            checkAoE.Checked = YBSettingsAss.Instance.CheckAoE;
            checkShadowstep.Checked = YBSettingsAss.Instance.CheckShadowstep;
            checkRecuperate.Checked = YBSettingsAss.Instance.CheckRecuperate;
            checkRecuperateCombo.Checked = YBSettingsAss.Instance.CheckRecuperateCombo;
            checkHealthStone.Checked = YBSettingsAss.Instance.CheckHealthStone;
            checkPoison.Checked = YBSettingsAss.Instance.CheckPoison;
            checkInterrupts.Checked = YBSettingsAss.Instance.CheckInterrupts;
            checkLifeblood.Checked = YBSettingsAss.Instance.CheckLifeblood;
            checkPotion.Checked = YBSettingsAss.Instance.CheckPotion;
            checkExposeArmor.Checked = YBSettingsAss.Instance.CheckExposeArmor;

            numShadowstep.Value = new decimal(YBSettingsAss.Instance.NumShadowstep);
            numRecuperate.Value = new decimal(YBSettingsAss.Instance.NumRecuperate);
            numRecuperateCombo.Value = new decimal(YBSettingsAss.Instance.NumRecuperateCombo);
            numHealthStone.Value = new decimal(YBSettingsAss.Instance.NumHealthStone);
            numLifeblood.Value = new decimal(YBSettingsAss.Instance.NumLifeblood);
        ...
        private void comboVendetta_SelectedIndexChanged(object sender, EventArgs e)
        {
            YBSettingsAss.Instance.Vendetta = (AbilityTrigger)GetComboBoxEnum(comboVendetta);
        }

        private void comboClassRacials_SelectedIndexChanged(object sender, EventArgs e)
        {
            YBSettingsAss.Instance.ClassRacials = (AbilityTrigger)GetComboBoxEnum(comboClassRacials);
        }

        private void comboShadowBlades_SelectedIndexChanged(object sender, EventArgs e)
        {
            YBSettingsAss.Instance.ShadowBlades = (AbilityTrigger)GetComboBoxEnum(comboShadowBlades);
        }

        private void comboVanish_SelectedIndexChanged(object sender, EventArgs e)
        {
            YBSettingsAss.Instance.Vanish = (AbilityTrigger)GetComboBoxEnum(comboVanish);
        }

        private void comboPoisonsM_SelectedIndexChanged(object sender, EventArgs e)
        {
            YBSettingsAss.Instance.PoisonSelectorM = (PoisonM)GetComboBoxEnum(comboPoisonsM);
        }

        private void comboPoisonsO_SelectedIndexChanged(object sender, EventArgs e)
        {
            YBSettingsAss.Instance.PoisonSelectorO = (PoisonO)GetComboBoxEnum(comboPoisonsO);
        }

        private void comboPreperation_SelectedIndexChanged(object sender, EventArgs e)
        {
            YBSettingsAss.Instance.Tier4Abilities = (AbilityTrigger)GetComboBoxEnum(comboPreperation);
        }

        private void comboTier6_SelectedIndexChanged(object sender, EventArgs e)
        {
            YBSettingsAss.Instance.Tier6Abilities = (AbilityTrigger)GetComboBoxEnum(comboTier6);
        }


        private void comboUseHands_SelectedIndexChanged(object sender, EventArgs e)
        {
            YBSettingsAss.Instance.UseHands = (AbilityTrigger)GetComboBoxEnum(comboUseHands);
        }

        private void comboTrinket1_SelectedIndexChanged(object sender, EventArgs e)
        {
            YBSettingsAss.Instance.Trinket1 = (AbilityTrigger)GetComboBoxEnum(comboTrinket1);
        }

        private void comboTrinket2_SelectedIndexChanged(object sender, EventArgs e)
        {
            YBSettingsAss.Instance.Trinket2 = (AbilityTrigger)GetComboBoxEnum(comboTrinket2);
        }
        #endregion
        ...
        {
            YBSettingsAss.Instance.NumShadowstep = (int)numShadowstep.Value;
        }
        private void numRecuperate_ValueChanged(object sender, EventArgs e)
        {
            YBSettingsAss.Instance.NumRecuperate = (int)numRecuperate.Value;
        }

        private void numRecuperateCombo_ValueChanged(object sender, EventArgs e)
        {
            YBSettingsAss.Instance.NumRecuperateCombo = (int)numRecuperateCombo.Value;
        }

        private void numHealthStone_ValueChanged(object sender, EventArgs e)
        {
            YBSettingsAss.Instance.NumHealthStone = (int)numHealthStone.Value;
        }
        private void numLifeblood_ValueChanged(object sender, EventArgs e)
        {
            YBSettingsAss.Instance.NumLifeblood = (int)numLifeblood.Value;
        }
        #endregion
        ...
        private void comboVendetta_MouseMove(object sender, MouseEventArgs e)
        {
            YBStatusStrip.Text = @"Select the usage of Vendetta.";
        }
        ...
        private void comboShadowBlades_MouseMove(object sender, MouseEventArgs e)
        {
