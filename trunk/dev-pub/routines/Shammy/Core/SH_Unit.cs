...
namespace Shammy.Core
{
    internal static class SmUnit
    {
        ...
        // Check if we don't Smck up while casting shouts ...
        ...
        {
            get { return Me.CurrentTarget.UseAoEList() && Interfaces.Settings.SmSettings.Instance.General.CheckSpecialAoE; }
        }
