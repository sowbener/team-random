...
{
    internal class SmSettingsU : Styx.Helpers.Settings
    {

        public SmSettingsU()
            : base(SmSettings.SettingsPath + "_Elemental.xml")
        {
        }
        ...
        [Setting]
        [Styx.Helpers.DefaultValue(SmEnum.WeaponImbueM.Flametongue)]
        ...
        public SmEnum.AbilityTrigger ElementalFrenzy { get; set; }
        #endregion
