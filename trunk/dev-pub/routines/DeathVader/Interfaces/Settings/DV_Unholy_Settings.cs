...
{
    internal class DvSettingsU : Styx.Helpers.Settings
    {

        public DvSettingsU()
            : base(DvSettings.SettingsPath + "_Unholy.xml")
        {
        }
        ...
        public DvEnum.AbilityTrigger SummonGargoyle { get; set; }
        ...
        public DvEnum.AbilityTrigger UnholyFrenzy { get; set; }
        #endregion
