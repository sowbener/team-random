...
namespace Bubbleman.Core
{
    internal static class BMUnit
    {
        ...
        // Check if we don't BMck up while casting shouts ...
        ...
        // Get UnitCount for Attackble MoBM.
        ...
        // Cache UnitCount for Attackable MoBM.
        ...
        {
            get { return Me.CurrentTarget.UseAoEList() && Interfaces.Settings.BMSettings.Instance.General.CheckSpecialAoE; }
        }
