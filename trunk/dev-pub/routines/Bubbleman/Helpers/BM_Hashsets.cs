...
{
    public static class BMHashSets
    {
        ...
        #region Other Lists
        public static bool TargetShieldBarrierList(this WoWUnit unit)
        {
        ...
        public static bool UseAoEList(this WoWUnit unit)
        {
            return unit != null && (ShieldBarrierIds.Contains(unit.Entry));
        }
        public static HashSet<uint> UseAoEIds { get { return UseAoE; } }
        private static readonly HashSet<uint> UseAoE = new HashSet<uint>
        {
            62164, // Garalon
            68905, // Twin Consorts - Lu'lin
            68904  // Twin Consorts - Suen
        ...
        private static readonly HashSet<uint> Bosses = new HashSet<uint> {
            ...
            //Hellfire Citadel: The Blood BMrnace
            17381, //The Maker
            17380, //Broggok
            ...
            //Pit of Saron
            36494, //Forgemaster GarUnholy111
            36477, //Krick
            ...
            33118, //Ignis the BMrnace Master
            33186, //Razorscale
            ...
            15204, //High Marshal WhirlaBMs <Abyssal High Council>
            ...
            61398, // BMn the Weaponmaster <King of the Clans>
            ...
            60410, // Elegon
            60400, // Jan-BM <Emperor's Open Hand>
            60399, // Qin-BM
