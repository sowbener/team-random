...
{
    internal class BMSettingsH : Styx.Helpers.Settings
    {
        public static BMSettingsH Instance = new BMSettingsH();

        public BMSettingsH()
            : base(BMSettings.SettingsPath + "_Hotkey.xml")
        {
        }
        ...
        [Setting]
        [Styx.Helpers.DefaultValue(BMEnum.Mode.Auto)]
        [Category("Hotkeys")]
        [DisplayName("Mode Selector")]
        [Description("Choose preferred Hotkey Mode.")]
        public BMEnum.Mode ModeSelection { get; set; }
