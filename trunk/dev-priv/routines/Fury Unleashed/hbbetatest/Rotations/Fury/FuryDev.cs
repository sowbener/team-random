    ...
    internal class FuryDev
    {
        ...
        internal static Composite Dev_FurySt()
        {
            return new PrioritySelector(
                ...
                Spell.MultiDoT(SpellBook.Bloodthirst, AuraBook.DeepWounds, 1000, 5, ret => Unit.NearbyAttackableUnitsCount > 1),
                ...
                Spell.Cast(SpellBook.WildStrike, ret => Global.BloodsurgeAura && Unit.NearbyAttackableUnitsCount == 1),
                ...
                Spell.Cast(SpellBook.WildStrike, ret => Global.ColossusSmashAura && Global.NormalPhase && Unit.NearbyAttackableUnitsCount == 1),
                ...
                Spell.Cast(SpellBook.WildStrike, ret => Global.ColossusSmashSpellCooldown >= 2000 && Lua.PlayerPower >= 70 && Global.NormalPhase && Unit.NearbyAttackableUnitsCount == 1),
            ...
            return new PrioritySelector(
                new Decorator(ret => Global.ColossusSmashAura,
                    new PrioritySelector(
                        ...
                        Spell.MultiDoT(SpellBook.Bloodthirst, AuraBook.DeepWounds, 1000, 5, ret => !Global.EnrageAura && Unit.NearbyAttackableUnitsCount > 1),
                ...
                new Decorator(ret => !Global.ColossusSmashAura,
                    new PrioritySelector(
                        ...
                        Spell.MultiDoT(SpellBook.Bloodthirst, AuraBook.DeepWounds, 1000, 5, ret => Lua.PlayerPower < 100 && Unit.NearbyAttackableUnitsCount > 1),
            ...
            return new PrioritySelector(
                new Decorator(ret => Unit.NearbyAttackableUnitsCount >= 4,
                    new PrioritySelector(
                        ...
                        Spell.MultiDoT(SpellBook.Bloodthirst, AuraBook.DeepWounds, 1000, 5),
