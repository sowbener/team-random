...
namespace YourRaidingBuddy.Rotations
{
    public class Summoner : Root
    {
        ...
        public static async Task<bool> Rotation()
        {
            ...
            if (!Me.CurrentTarget.HasAura("Bio II") && await Spell.CastSpell("Bio II", () => !Me.CurrentTarget.HasAura("Bio II"))) return true;
            await Spell.NoneGcdCast("Painflare", Me.CurrentTarget, () => !Me.HasAura("Aethertrail Attunement") && Me.CurrentTarget.HasAura("Bio II"));
            await Spell.CastSpell("Miasma", () => !Me.CurrentTarget.HasAura("Miasma"));
            await Spell.CastSpell("Bio", () => !Me.CurrentTarget.HasAura("Bio"));
            await Spell.NoneGcdCast("Spur", Me.CurrentTarget, () => Me.CurrentTarget.HasAura("Bio"));
            await Spell.NoneGcdCast("Fester", Me.CurrentTarget, () => Me.CurrentTarget.HasAura("Bio", false, 16500));
            if (Me.CurrentTarget.HasAura("Bio") && Me.CurrentTarget.HasAura("Bio II") && Me.CurrentTarget.HasAura("Miasma"))
            {
                ...
                await Spell.NoneGcdCast("Painflare", Me.CurrentTarget, () => Me.HasAura("Aethertrail Attunement") && Me.Auras.GetAuraStacksById(807) == 1);
                await Spell.NoneGcdCast("Aetherflow", Me, () => Me.HasAura("Aethertrail Attunement") && Me.Auras.GetAuraStacksById(807) == 2);
                await Spell.NoneGcdCast("Raging Strikes", Me, () => Me.HasAura("Aethertrail Attunement") && Me.Auras.GetAuraStacksById(807) == 3);
                await Spell.NoneGcdCast("Dreadwyrm Trance", Me, () => Me.HasAura("Aethertrail Attunement") && Me.Auras.GetAuraStacksById(807) == 3);
             }
